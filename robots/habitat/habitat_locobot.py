...
import quaternion
from tf.transformations import euler_from_quaternion, euler_from_matrix, quaternion_from_matrix
...
class HabitatLocobot:
	...
	def pub_odom_state(self, quat, pos):
		msg = Odometry()
	...
	def get_state(self):
		...
		self.pub_odom_state(quat, true_position)
